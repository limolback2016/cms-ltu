...
public class DbConnection {
	...
	private Logger logger = null; // use for debugging purpose when we do
								  // unit-test
	...
	private void init() throws Exception {
		try {
			this.file = new FileInputStream(DbConnection.class.getResource(
					"/Files/db.properties").getPath());
			prop.load(this.file);
	...
	public Connection connect() {
		try {
			String DB_URL = "jdbc:mysql://" + serverAddress + ":" + port + "/"
					+ db;
